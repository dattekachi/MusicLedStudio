...
from mls.utils import currently_frozen
...
def setup_sentry():
    ...
    if is_release == "false":
        ...
        try:
            ...
            release = f"mls@{PROJECT_VERSION}-{commit_hash}"
    else:
