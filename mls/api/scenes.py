...
class ScenesEndpoint(RestEndpoint):
    ...
    async def get(self) -> web.Response:
        ...
        response = {
            "status": "success",
            "scenes": self._mls.config["scenes"],
        }
    ...
    async def delete(self, request: web.Request) -> web.Response:
        ...
        del self._mls.config["scenes"][scene_id]
    ...
    async def put(self, request: web.Request) -> web.Response:
        ...
        if action == "activate_in":
            ...
            self._mls.loop.call_later(
                ms, self._mls.scenes.activate, scene_id
            )
            return await self.request_success(
        ...
        if action == "activate":
            ...
            self._mls.config["scenes"][scene_id]["name"] = name
            save_config(
                config=self._mls.config,
                config_dir=self._mls.config_dir,
            )
    ...
    async def post(self, request: web.Request) -> web.Response:
        ...
        self._mls.config["scenes"][scene_id] = scene_config
