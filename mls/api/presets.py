...
from mls.utils import generate_defaults, inject_missing_default_keys
...
class PresetsEndpoint(RestEndpoint):
    ...
    async def get(self, effect_id) -> web.Response:
        ...
        try:
            self._mls.effects.get_class(effect_id)
    ...
    async def put(self, effect_id, request) -> web.Response:
        ...
        self._mls.config[category][effect_id][preset_id]["name"] = name
        save_config(
    ...
    async def delete(self, effect_id, request) -> web.Response:
        ...
        del self._mls.config[category][effect_id][preset_id]
