...
# from mls.api.websocket import WebsocketConnection
...
class IntegrationsEndpoint(RestEndpoint):
    ...
    async def get(self, request=None) -> web.Response:
        ...
        for integration in self._mls.integrations.values():
    ...
    async def put(self, request: web.Request) -> web.Response:
        ...
        integration = self._mls.integrations.get(integration_id)
        ...
        for _integration in self._mls.config["integrations"]:
    ...
    async def delete(self, request: web.Request) -> web.Response:
        ...
        self._mls.integrations.destroy(integration_id)

        self._mls.config["integrations"] = [
            integration
            for integration in self._mls.config["integrations"]
    ...
    async def post(self, request: web.Request) -> web.Response:
        ...
        if integration_id is None:
            ...
            existing_integration = self._mls.integrations.get(integration_id)
        ...
        integration = self._mls.integrations.create(
            id=integration_id,
        ...
        # Update and save the configuration
        if new:
            self._mls.config["integrations"].append(
                {
                    "id": integration.id,
                    "type": integration.type,
                    "active": integration.active,
