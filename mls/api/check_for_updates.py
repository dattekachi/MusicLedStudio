...
from mls.utils import UpdateChecker

_LOGGER = logging.getLogger(__name__)


class CheckMusicLedStudioUpdatesEndPoint(RestEndpoint):
    ...
    async def get(self) -> web.Response:
        ...
        if is_release == "false":
            return await self.request_success(
                type="info",
                message="This instance of MusicLedStudio is not an official release - happy developing!",
            )
        ...
        if UpdateChecker.get_release_information():
            ...
            if UpdateChecker.update_available():
                msg = "New MusicLedStudio version is available"
                ...
                msg = "MusicLedStudio is up to date"
                _LOGGER.info(f"{msg}.")
