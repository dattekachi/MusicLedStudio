...
# from mls.effects.audio import FREQUENCY_RANGES
...
from mls.color import hsv_to_rgb, parse_color, validate_color
...
class Effects(RegistryLoader):
    ...
    PACKAGE_NAME = "mls.effects"

    def __init__(self, mls):
        super().__init__(mls=mls, cls=Effect, package=self.PACKAGE_NAME)
        self._mls.audio = None
