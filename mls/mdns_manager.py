...
from mls.utils import async_fire_and_forget
...
class ZeroConfRunner:
    ...
    def __init__(self, mls):
        ...
        def on_shutdown(e):
            async_fire_and_forget(self.async_close(), self._mls.loop)
    ...
    async def add_wled_device(
        ...
        if info:
            ...
            async_fire_and_forget(
                self._mls.devices.add_new_device(device_type, device_config),
                loop=self._mls.loop,
