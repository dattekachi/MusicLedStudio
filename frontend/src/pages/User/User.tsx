    ...
    >
      ...
      >
        <Collapse in={infoAlerts.user}>
          ...
          >
            MusicLedStudio Cloud is a proof of concept and is running on a cheap
            six bucks a month server.
            <br />
                    ...
                    <Stepper nonLinear activeStep={1} alternativeLabel>
                      <Step key="core" completed={starred.core}>
                        <StepButton
                          onClick={() => {
                            window.open(
                              'https://github.com/MusicLedStudio/LedFx',
                              '_blank'
                            )
                          }}
                          sx={{
                        ...
                        <Popover
                          ...
                          content={
                            <Stack>
                              ...
                              >
                                MusicLedStudio will restart after
                              </Typography>
                            </Stack>
                          }
                          type="iconbutton"
