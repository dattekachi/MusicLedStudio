...
const PresetsCard = ({ virtual, effectType, presets, style }: any) => {
  ...
  return (
    <Card variant="outlined" className="step-device-three" style={style}>
      <CardHeader
        style={{ margin: '0' }}
        title="Cấu hình sẵn có"
        subheader="Khám phá các cấu hình hiệu ứng sẵn có hoặc tự tạo hiệu ứng cho riêng bạn."
      />
      <CardContent>
            ...
            <Popover
              ...
              footer={
                <div style={{ margin: '0 0 0.5rem 1rem' }}>
                  ...
                  >
                    Lưu lại cấu hình hiệu ứng tùy chỉnh hiện tại.
                  </Typography>
                </div>
              }
              confirmDisabled={
        ...
        <div style={{ flexDirection: 'column', flex: 1, padding: '0 0.5rem' }}>
          ...
          >
            <Typography
              ...
              sx={{ color: theme.palette.text.disabled }}
            >
              Nhấn giữ hoặc nhấn chuột phải để mở menu ngữ cảnh
            </Typography>
          </div>
