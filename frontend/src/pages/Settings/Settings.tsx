...
const Settings = () => {
  ...
  return (
    <div className={classes.card} style={{ marginBottom: '3rem' }}>
      ...
      <SettingsAccordion title="Cài đặt chung" accId="3" icon="Settings">
        <GeneralCard />
      </SettingsAccordion>
      <SettingsAccordion title="Cài đặt âm thanh" accId="1a" icon="Speaker">
        <>
          {features.webaudio && (
            <Webaudio
      ...
      <SettingsAccordion title="Cài đặt giao diện" accId="2a" icon="Widgets">
        <UICard />
      </SettingsAccordion>
      ...
      {viewMode !== 'user' && (
        <>
          ...
          <SettingsAccordion title="Cài đặt nâng cao" accId="2y3" icon="Star">
            <ExpertFeatures />
          </SettingsAccordion>
          {/* {features.beta && (
            <SettingsAccordion
