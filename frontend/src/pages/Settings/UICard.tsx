...
const UICard = () => {
  ...
  return (
    <>
      ...
      <SettingsRow title="Độ mượt (FPS)" step="two" value={fps}>
        <SettingsSlider
          value={fps}
          step={1}
          min={1}
      ...
      <SettingsRow title="Điểm ảnh giao diện" step="three" value={pixelLength}>
        <SettingsSlider
          value={pixelLength}
          step={1}
      ...
      <SettingsRow title="Độ sáng của LED" step="two" value={globalBrightness}>
        <SettingsSlider
      ...
      <SettingsRow
        title="Thời gian cập nhật thông báo"
