...
openapi: 3.1.0
info:
  title: MusicLedStudio API
  version: '1.0'
  summary: MusicLedStudio API
  description: MusicLedStudio API
  contact: {}
  license:
    name: GPL3
            ...
            application/json:
              schema:
                ...
                required:
                  ...
                  - very-verbose
                  - virtuals
      description: Get the whole MusicLedStudio config-tree
  /devices:
    get:
      summary: GET Devices
      tags: []
      ...
      description: Get the whole MusicLedStudio devices-tree
  /virtuals:
    get:
      ...
      description: Get the whole MusicLedStudio virtuals-tree
  '/virtuals/{virtualId}':
    get:
      summary: GET Virtual
      tags: []
