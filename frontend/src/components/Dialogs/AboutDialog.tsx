...
export default function AboutDialog({ className, children, startIcon }: any) {
  ...
  const [bcommit, setMusicLedStudioSHA] = useState('')
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (info) {
        setMusicLedStudioSHA(info.github_sha)
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="about-dialog-title">About MusicLedStudio</DialogTitle>
        <DialogContent>
          <div style={{ minWidth: 250 }}>
            <Card style={{ marginBottom: '1rem' }}>
              <CardHeader title="MusicLedStudio Version" />
