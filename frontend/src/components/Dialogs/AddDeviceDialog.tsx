  ...
  return (
    ...
    >
      <DialogTitle id="form-dialog-title">
        ...
        Object.keys(initial.config).length === 0 &&
        initial.config?.constructor === Object
          ? `Thêm thiết bị ${deviceType.toUpperCase()}`
          : `Chỉnh sửa thiết bị ${deviceType.toUpperCase()}`}
      </DialogTitle>
      <DialogContent>
        <DialogContentText>
          Để thêm thiết bị vào Music Led Studio, trước tiên hãy chọn loại thiết
          bị phía bên dưới sau đó điền thông số cấu hình cần thiết.
        </DialogContentText>
