...
def pytest_sessionstart(session):
    """
    Function to start MusicLedStudio as a subprocess and initialize necessary variables.
    It is called once at the start of the pytest session, before any tests are run.
    We use this function to start MusicLedStudio as a subprocess and initialize the all_effects variable.
    ...
    try:
        ...
        pytest.fail(f"An error occurred while starting MusicLedStudio: {str(e)}")
